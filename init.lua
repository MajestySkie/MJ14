...
-- Tambahkan Dragable Image sebagai Tombol
local function toggleFluentFrame()
	if Library.Window then
		Library.Window.Frame.Visible = not Library.Window.Frame.Visible
	end
end

Creator.CreateDragableImage(
	GUI,
	"98803367684553", -- Asset ID untuk gambar
	Vector2.new(60, 60), -- Ukuran gambar
	UDim2.new(0.1, 0, 0.1, 0), -- Posisi gambar
	toggleFluentFrame
)
